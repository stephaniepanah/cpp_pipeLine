/**
	@file IPipeSegmentBase.h
	@brief The IPipeSegmentBase class header file.
	...
	@see	IPipeSegmentBase
	@bug	None known

*/

#ifndef IPIPESEGMENTBASE_H
...
public:
	...
	virtual ~IPipeSegmentBase() {};
};

}

#endif /*IPIPESEGMENTBASE_H*/
